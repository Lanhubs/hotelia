...
export const PAYMENT_PROVIDER = 'KEO Payment Partner'

export const MOCK_TRANSFER_BANK = {
  bankName: 'Paystack Virtual Account (Wema)',
  accountName: 'KEO Experience Hotel & Events',
